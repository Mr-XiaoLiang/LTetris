...
public class J extends Bean {
	...
	private int[] x0 = {0,0,0,-1};
	private int[] y0 = {-1,0,1,1};
	private int[] x1 = {1,0,-1,-1};
	private int[] y1 = {0,0,0,-1};
	private int[] x2 = {0,0,0,1};
	private int[] y2 = {1,0,-1,-1};
	private int[] x3 = {-1,0,1,1};
	private int[] y3 = {0,0,0,1};
	...
	public J(int color, int x, int y) {
		super(color, x, y);
	}
}
